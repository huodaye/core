			...
			if ($this->canChangePassword()) {
				...
				if ($result) {
					if ($this->emitter) {
						...
						$event = new GenericEvent(null, ['user' => $this, 'password' => $password, 'recoveryPassword' => $recoveryPassword]);
						$this->eventDispatcher->dispatch('user.aftersetpassword.data', $event);
					}
